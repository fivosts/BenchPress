...
def ExtractRawFeatures(src: str, *extra_args) -> str:
  """
...
def RawToDictFeats(str_features: str) -> typing.Dict[str, float]:
  """
...
def ExtractFeatures(src: str, *extra_args) -> typing.Dict[str, float]:
  """
