...
class tfBert(backends.BackendBase):
  ...
  ## This is BertConfig.__init__ + BertModel.__init__
  def InitTfGraph(
  ...
  run_config = tf.contrib.tpu.RunConfig(
      ...
      master=FLAGS.master,
      model_dir=FLAGS.output_dir, ## TODO
  ...
  model_fn = model_fn_builder(
      ...
      learning_rate=FLAGS.learning_rate, ## TODO
      num_train_steps=FLAGS.num_train_steps, ## TODO
      num_warmup_steps=FLAGS.num_warmup_steps, ## TODO
